...
num_processes = 4  # Número de processos desejado
def camIP_Bloq(request):
    fullscreen = False
        ...
        try:
            for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
                ...
                if "Estudante" in name:
                    ...
                    arduino.write(b'2')  # Envia imediatamente o número 2 para o Arduino
    ...
    if loaded_data:
        ...
        #URL da câmera IP
        #URL = 'rtsp://admin:%26%40%243264Lucas@192.168.1.65:554/onvif1'
        URL = 'rtsp://admin:123456789LB@192.168.1.150:554/cam/realmonitor?channel=1&subtype=0'
        print('Conectando com: ' + URL)

        # Inicializa a captura da câmera IP
        ...
        while True:
            ...
            if key == ord('x') or key == ord('X'):
                 arduino.write(b'5')  # Envia '0' para o Arduino
